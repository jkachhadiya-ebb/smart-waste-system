...
SELECT
  ...
  COALESCE(t.truck_code, de.truck_id::text)::VARCHAR(50) AS truck_id,
  ROUND(de.total_weight_kg / 1000.0, 2)::NUMERIC(14,2) AS total_waste_t,
  ROUND(de.bio_kg          / 1000.0, 2)::NUMERIC(14,2) AS bio_t,
  ROUND(de.plastic_kg      / 1000.0, 2)::NUMERIC(14,2) AS plastic_t,
  ROUND(de.cardboard_kg    / 1000.0, 2)::NUMERIC(14,2) AS cardboard_t,
  ROUND(de.metal_kg        / 1000.0, 2)::NUMERIC(14,2) AS metal_t,
  ROUND(de.other_kg        / 1000.0, 2)::NUMERIC(14,2) AS other_t,
  de.load_volume_m3::NUMERIC(14,3)                     AS landfill_used_m3,
  de.landfill_used_after_m3::NUMERIC(14,3)             AS landfill_total_used_m3,
  de.municipality_id,
  de.landfill_site_id
