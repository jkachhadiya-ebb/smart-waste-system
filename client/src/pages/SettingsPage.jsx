  ...
  return (
    <div>
      <div className="settings-page">
        <div className="settings-shell space-y-6 rounded-[30px] bg-white px-6 py-6 shadow-lg shadow-slate-300/30 lg:px-8">
          ...
          <div className="settings-tabs w-full rounded-[32px] bg-slate-100 p-1">
            <div className="settings-tabs-list flex w-full gap-2 rounded-[28px] bg-white/80 p-1">
              {TABS.map((tab) => {
                ...
                return (
                  <button
                    ...
                    className={`settings-tab flex-1 rounded-[26px] px-5 py-3 text-sm font-semibold transition ${
                      isActive
